...
bool operator==(const ::controller_modules::JointControlRequest_<ContainerAllocator1> & lhs, const ::controller_modules::JointControlRequest_<ContainerAllocator2> & rhs)
{
