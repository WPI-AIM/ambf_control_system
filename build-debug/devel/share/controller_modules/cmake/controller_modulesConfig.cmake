...
if("TRUE" STREQUAL "TRUE")
  set(controller_modules_SOURCE_PREFIX /localcodebase/ambf_repos/ambf_control_system/controller_modules)
  set(controller_modules_DEVEL_PREFIX /localcodebase/ambf_repos/ambf_control_system/build-debug/devel)
  ...
  set(controller_modules_INSTALL_PREFIX /usr/local)
...
if(NOT "/localcodebase/ambf_repos/ambf_control_system/build-debug/devel/include;/localcodebase/ambf_repos/ambf_control_system/controller_modules/include " STREQUAL " ")
  set(controller_modules_INCLUDE_DIRS "")
  set(_include_dirs "/localcodebase/ambf_repos/ambf_control_system/build-debug/devel/include;/localcodebase/ambf_repos/ambf_control_system/controller_modules/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_modules' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/localcodebase/ambf_repos/ambf_control_system/controller_modules/${idir}'.  ${_report}")
    endif()
    _list_append_unique(controller_modules_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "controller_modules")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT controller_modules_NUM_DUMMY_TARGETS)
      set(controller_modules_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::controller_modules::wrapped-linker-option${controller_modules_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR controller_modules_NUM_DUMMY_TARGETS "${controller_modules_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::controller_modules::wrapped-linker-option${controller_modules_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND controller_modules_LIBRARIES "${interface_target_name}")
...
set(controller_modules_EXPORTED_TARGETS "controller_modules_generate_messages_cpp;controller_modules_generate_messages_eus;controller_modules_generate_messages_lisp;controller_modules_generate_messages_nodejs;controller_modules_generate_messages_py")
...
set(depends "geometry_msgs;trajectory_msgs;tf")
