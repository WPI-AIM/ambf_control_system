...
//    const std::string actuator_config_file_ = "/localcodebase/ambf_repos/nag92/ambf/ambf_models/descriptions/multi-bodies/robots/blender-kuka.yaml";
//    const std::string actuator_config_file_ = "/localcodebase/ambf_repos/nag92/ambf/ambf_models/descriptions/multi-bodies/robots/blender-psm.yaml";
    const std::string actuator_config_file_ = "/home/shreyas/Downloads/exo/default.yaml";
