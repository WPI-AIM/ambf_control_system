...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_modules' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nathaniel/catkin_ws/src/ambf_control_system/matlab_msg_gen_ros1/glnxa64/install/${idir}'.  ${_report}")
    endif()
