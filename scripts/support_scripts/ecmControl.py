...
# 	if i < 1:
	...
	set_joint_pos_wrapper(baselink_handler, 		 				  "baselink-yawlink", 0.0) #math.pi / 2.0)
	set_joint_pos_wrapper(baselink_handler, 				 "yawlink-pitchbacklink", math.pi / 4.0)
	set_joint_pos_wrapper(baselink_handler, "pitchendlink-maininsertionlink", 0.0) #0.1)
	set_joint_pos_wrapper(baselink_handler, 		"maininsertionlink-toollink", 0.0) #math.pi / 4.0)
